...
if __name__ == "__main__":
    ...
    hidden_5 = keras.layers.Dense(64,activation=None)(hidden_4)
    hidden_6 = keras.layers.Dense(64,activation=None)(hidden_5)
    hidden_7 = keras.layers.Dense(64,activation=None)(hidden_6)
    
    # concat_layer = keras.layers.Concatenate()([hidden_1,hidden_7])
    # output_layer = keras.layers.Dense(2,None)(concat_layer)
